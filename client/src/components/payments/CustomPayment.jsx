    ...
    return (
        <>
            ...
            <button
                ...
                className="w-full bg-teal-50 dark:bg-teal-500/10 text-teal-700 dark:text-teal-300 border border-teal-200 dark:border-teal-500/15 px-6 py-4 rounded-xl hover:bg-teal-100 dark:hover:bg-teal-500/18 transition flex items-center justify-center gap-3 shadow-sm"
            >
                <Gift className="w-5 h-5 text-teal-600 dark:text-teal-400" />
                <span className="font-semibold">Tambah Pemasukan Custom</span>
                <span className="text-xs bg-teal-100 dark:bg-white/[0.06] px-2 py-1 rounded-md text-teal-800 dark:text-white/60">
                        ...
                        <div className="p-6 border-b border-slate-200 dark:border-white/10">
                            <div className="flex items-start justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="bg-indigo-600 dark:bg-blue-500 p-2.5 rounded-xl text-white">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-white/60">
                                            Sumber pemasukan lain untuk kas kelas
                                        </p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => setShowModal(false)}
                                    className="p-1.5 text-slate-400 hover:text-slate-600 dark:text-white/40 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.07] rounded-lg transition-colors"
                                >
                                    <X className="w-5 h-5" />
                                </button>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-white/60 text-sm font-medium">
                                        Rp
                                    </span>
                                    <input
                                        type="number"
                                        ...
                                        step="500"
                                        placeholder="50000"
                                        className="w-full pl-10 pr-3 py-2.5 bg-slate-50 dark:bg-white/[0.06] border border-slate-300 dark:border-white/[0.1] rounded-xl focus:ring-2 focus:ring-indigo-400/25 focus:border-indigo-500 dark:focus:border-transparent transition-all duration-200 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/40"
                                    />
                                </div>
                                <p className="text-xs text-slate-500 dark:text-white/60 mt-1">
                            ...
                            {/* Info Box */}
                            <div className="bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200 dark:border-blue-500/20 rounded-xl p-3">
                            ...
                            <div className="flex gap-3 pt-2">
                                <button
                                    ...
                                    onClick={() => setShowModal(false)}
                                    disabled={loading}
                                    className="flex-1 px-4 py-2 border border-slate-300 dark:border-white/[0.1] text-slate-700 dark:text-white rounded-xl hover:bg-slate-100 dark:hover:bg-white/[0.04] transition disabled:opacity-50 font-medium"
                                >
                                    Batal
                                </button>
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex-1 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition flex items-center justify-center gap-2 disabled:opacity-50 font-medium shadow-sm"
                                >
                                    {loading ? (
                                        <>
