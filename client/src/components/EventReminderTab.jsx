        ...
        <div className="space-y-6">
            ...
            {selectedEvent && (
                <>
                    ...
                    <div className="bg-slate-800/90 border border-slate-700/50 rounded-lg border">
                        ...
                        <div className="p-4">
                            {eventUnpaidStudents.length === 0 ? (
                                ...
                                <div>
                                    <div className="bg-amber-500/20 border border-yellow-200 rounded-lg p-3 mb-3">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-60 overflow-y-auto">
                                        {eventUnpaidStudents.map((student) => (
                                            <div
                                                key={student._id}
                                                className="flex items-center gap-2 p-2 bg-slate-800/60 rounded"
                                            >
                                                <div className="w-2 h-2 bg-rose-500/200 rounded-full"></div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-2 px-4 py-3 bg-white border-2 border-purple-300 text-purple-700 rounded-lg hover:bg-purple-50 disabled:bg-slate-700/50 disabled:text-slate-400 disabled:border-slate-700/50 transition-colors"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-2 px-4 py-3 bg-purple-600 text-slate-50 rounded-lg hover:bg-purple-700 disabled:bg-gray-300 transition-colors font-medium"
                                    >
                                ...
                                {groupPreview && (
                                    <div className="bg-slate-900/95 backdrop-blur-xl p-4 rounded-lg border mt-4">
                                        <p className="text-sm font-medium text-slate-200 mb-2">
                                            Preview Pesan:
                                        </p>
                                        <div className="bg-slate-800/60 p-3 rounded">
                                            <pre className="text-sm whitespace-pre-wrap text-slate-100 font-mono">
                                                {groupPreview}
                                            </pre>
                                        </div>
                                    </div>
                    ...
                    {/* How to get Group ID */}
                    <div className="bg-slate-800/60 rounded-lg p-4 border">
                        <h4 className="font-semibold text-slate-100 mb-2 flex items-center gap-2">
                            <AlertCircle className="w-4 h-4" />
                            Cara Mendapatkan Group ID
                        </h4>
                        <ol className="text-sm text-slate-200 space-y-2 ml-4">
                            <li>
