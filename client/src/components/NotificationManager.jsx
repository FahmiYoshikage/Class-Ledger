        ...
        <div className="max-w-7xl mx-auto p-3 sm:p-6">
            ...
            <div className="mb-4 sm:mb-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-3 sm:mb-4">
                    ...
                    <button
                        onClick={loadData}
                        disabled={loading}
                        className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-white border-2 border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
                    >
                        <RefreshCw
                            className={`w-4 h-4 ${
                ...
                {apiStatus && (
                    ...
                    >
                        {apiStatus.testMode ? (
                            ...
                            <>
                                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#0071e3] flex-shrink-0" />
                                <span className="text-xs sm:text-sm text-[#0071e3]">
            ...
            {stats && (
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
                    <div className="bg-white/95 backdrop-blur-xl p-3 sm:p-4 rounded-lg shadow border-l-4 border-blue-500">
                    ...
                    <div className="bg-white/95 backdrop-blur-xl p-3 sm:p-4 rounded-lg shadow border-l-4 border-red-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-600 text-xs sm:text-sm">
                                    Gagal
                    ...
                    <div className="bg-white/95 backdrop-blur-xl p-3 sm:p-4 rounded-lg shadow border-l-4 border-green-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-600 text-xs sm:text-sm">
                                    7 Hari
                    ...
                    <div className="bg-white/95 backdrop-blur-xl p-3 sm:p-4 rounded-lg shadow border-l-4 border-yellow-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-600 text-xs sm:text-sm">
                                    Perlu Reminder
            ...
            {/* Tabs */}
            <div className="bg-white backdrop-blur-xl border border-gray-200 shadow-apple-sm rounded-xl mb-4 sm:mb-6 overflow-hidden">
                ...
                <div className="p-3 sm:p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 px-4 py-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors text-sm sm:text-base"
                                >
                                ...
                                <div className="flex gap-2 sm:gap-3">
                                    <button
                                        onClick={selectAll}
                                        className="flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-blue-50 text-blue-500 rounded-lg hover:bg-blue-100 transition-colors text-sm sm:text-base"
                                    >
                                        Pilih Semua
                                    </button>
                                ...
                                <button
                                    ...
                                    disabled={sending}
                                    className="w-full sm:w-auto sm:ml-auto flex items-center justify-center gap-2 px-4 sm:px-6 py-2 bg-[#0071e3] text-white rounded-xl hover:bg-[#0077ED] disabled:opacity-50 disabled:cursor-not-allowed transition-all text-sm sm:text-base"
                                >
                                    {sending ? (
                                        <>
                            ...
                            {showPreview && (
                                <div className="bg-gradient-to-br from-green-50 to-blue-50 p-6 rounded-lg border-2 border-blue-200">
                                    ...
                                    <div className="bg-white/95 backdrop-blur-xl p-4 rounded-lg whitespace-pre-wrap font-mono text-sm border border-gray-200 bg-gray-50 text-gray-900">
                                        {previewMessage}
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors"
                                >
                                    <Eye className="w-4 h-4" />
                                    Preview Pesan
                                </button>
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-6 py-2 bg-[#0071e3] text-white rounded-xl hover:bg-[#0077ED] disabled:opacity-50 disabled:cursor-not-allowed transition-all ml-auto"
                                >
                                    {sending ? (
                                        <>
                                            <RefreshCw className="w-4 h-4 animate-spin" />
                            ...
                            {showPreview && groupPreview && (
                                <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-lg border-2 border-purple-200">
                                    ...
                                    <div className="bg-white/95 backdrop-blur-xl p-4 rounded-lg whitespace-pre-wrap font-mono text-sm border border-gray-200 bg-gray-50 text-gray-900 max-h-96 overflow-y-auto">
                                        {groupPreview}
                                    </div>
                                ...
                                <ol className="space-y-2 text-sm text-gray-600">
                                    ...
                                    <li className="flex gap-2">
                                        ...
                                        <div>
                                            ...
                                            <pre className="bg-gray-800 text-emerald-600 p-2 rounded mt-1 text-xs overflow-x-auto">
                                                curl -X POST
                    ...
                    {activeTab === 'event' && (
                        <div className="space-y-6">
                            ...
                            {/* Event Selection */}
                            <div className="bg-white/95 backdrop-blur-xl p-4 rounded-lg border">
                                <label className="block text-sm font-medium text-gray-600 mb-2">
                                    Pilih Event
                                </label>
                                <select
                            ...
                            {selectedEvent && (
                                <>
                                    ...
                                    <div className="bg-white border border-gray-200 shadow-apple rounded-lg border">
                                        <div className="p-4 border-b flex justify-between items-center">
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    className="text-sm px-3 py-1 bg-gray-100 hover:bg-gray-100 rounded"
                                                >
                                                    {selectedEventStudents.length ===
                                                    eventUnpaidStudents.length
                                                        ? 'Unselect All'
                                    ...
                                    {eventUnpaidStudents.length > 0 && (
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                            <button
                                                ...
                                                disabled={loading}
                                                className="flex items-center justify-center gap-2 px-4 py-3 bg-gray-100 hover:bg-gray-100 rounded-lg transition-colors"
                                            >
                                    ...
                                    {showGroupModal && (
                                        <div className="fixed inset-0 bg-black/40 backdrop-blur-md flex items-center justify-center z-50 p-4">
                                            <div className="bg-white border border-gray-200 shadow-apple rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                                                <div className="p-6">
                                                    ...
                                                    <div className="space-y-4">
                                                        ...
                                                        <div>
                                                            <button
                                                                ...
                                                                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-100 rounded-lg"
                                                            >
                                                                <Eye className="w-4 h-4" />
                                                                Preview Pesan
                                                                Grup
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-2 px-6 py-2 bg-gray-100 hover:bg-gray-100 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <Eye className="w-4 h-4" />
                                        Preview
                                    </button>
                            ...
                            {customPreview && (
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 bg-gray-50 text-gray-900">
                                    ...
                                    <div className="bg-white/95 backdrop-blur-xl p-4 rounded-lg border border-gray-200">
                                        <pre className="text-sm whitespace-pre-wrap text-gray-900 font-sans">
                                            {customPreview}
                                        </pre>
                                    </div>
                            ...
                            {notifications.length === 0 ? (
                                ...
                                <div className="space-y-2">
                                    {notifications.slice(0, 20).map((notif) => (
                                        <div
                                            key={notif._id}
                                            className="bg-white/95 backdrop-blur-xl p-4 rounded-lg border border-gray-200 bg-gray-50 text-gray-900"
                                        >
                                            ...
                                            <p className="text-sm text-gray-600 bg-gray-50 p-3 rounded whitespace-pre-wrap border border-gray-200 bg-gray-50 text-gray-900">
                                                {notif.message}
                                            </p>
                            ...
                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                                ...
                                <div className="space-y-3 text-sm text-gray-600">
                                    ...
                                    <div>
                                        ...
                                        <pre className="ml-4 bg-gray-800 text-emerald-600 p-3 rounded mt-2 font-mono text-xs overflow-x-auto">
...
AUTO_REMINDER_ENABLED=true`}
                            ...
                            <div className="bg-amber-50 p-6 rounded-lg border border-yellow-200">
