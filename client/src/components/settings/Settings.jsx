...
const Settings = ({ onStartDateChange, currentStartDate, onWeekChange, onConfigUpdated }) => {
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <div className="rounded-2xl bg-white/80 dark:bg-zinc-950/60 border border-slate-200 dark:border-white/10 p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shadow-sm">
                <div className="flex items-center gap-3">
                    <div className="bg-indigo-600/15 dark:bg-indigo-600/20 text-indigo-600 dark:text-indigo-400 p-3 rounded-xl border border-indigo-500/20 dark:border-indigo-500/30">
            ...
            {/* Notification Alert */}
            {success && (
                <div className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 p-4 rounded-xl flex items-center gap-2 text-sm animate-fade-in">
                    <CheckCircle2 className="w-5 h-5 flex-shrink-0" />
                    <span>{success}</span>
                </div>
            )}
            {error && (
                <div className="bg-rose-500/10 border border-rose-500/30 text-rose-600 dark:text-rose-400 p-4 rounded-xl flex items-center gap-2 text-sm animate-fade-in">
            ...
            {/* Sub-Tabs Nav */}
            <div className="flex overflow-x-auto gap-2 p-1.5 rounded-2xl bg-slate-200/60 dark:bg-zinc-950/40 border border-slate-300/60 dark:border-white/5 no-scrollbar">
                {navTabs.map((tab) => {
                    const Icon = tab.icon;
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold transition-all whitespace-nowrap cursor-pointer ${
                                isActive
                                    ...
                                    : 'text-slate-600 dark:text-white/60 hover:text-slate-900 dark:hover:text-white hover:bg-white/60 dark:hover:bg-white/[0.04]'
                            }`}
                        >
            ...
            {/* Form Container */}
            <form onSubmit={handleSave} className="rounded-2xl bg-white/80 dark:bg-zinc-950/60 border border-slate-200 dark:border-white/10 p-6 space-y-6 shadow-sm">
                {/* TAB 1: PROFIL KELAS */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs font-medium text-slate-700 dark:text-white/70 mb-1.5">
                                    Nama Kelas <span className="text-rose-500 dark:text-rose-400">*</span>
                                </label>
                                <input
                                    type="text"
                                    value={className}
                                    ...
                                    required
                                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-white/[0.04] border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/30 text-xs sm:text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition"
                                />
                            </div>
                ...
                {activeSubTab === 'kas' && (
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label className="block text-xs font-medium text-slate-700 dark:text-white/70 mb-1.5">
                                    Nominal Kas Per Minggu (Rp) <span className="text-rose-500 dark:text-rose-400">*</span>
                                </label>
                                <div className="relative">
                                    <span className="absolute left-3.5 top-2.5 text-xs text-slate-500 dark:text-white/40 font-mono">Rp</span>
                                    <input
                                        type="number"
                                        min="500"
                                        step="500"
                                        ...
                                        required
                                        className="w-full pl-10 pr-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-white/[0.04] border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/30 text-xs sm:text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition font-mono"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                <label className="block text-xs font-medium text-slate-700 dark:text-white/70 mb-1.5">
                                    Batas Telat (Minggu) <span className="text-rose-500 dark:text-rose-400">*</span>
                                </label>
                                <input
                                    type="number"
                                    min="1"
                                    ...
                                    required
                                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-white/[0.04] border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/30 text-xs sm:text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition font-mono"
                                />
                            ...
                            <div>
                                <label className="block text-xs font-medium text-slate-700 dark:text-white/70 mb-1.5">
                                    Tanggal Mulai Pembayaran <span className="text-rose-500 dark:text-rose-400">*</span>
                                </label>
                                <input
                                    type="date"
                                    value={startDate}
                        ...
                        <div className="p-4 rounded-2xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.08] space-y-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h4 className="text-sm font-bold text-slate-900 dark:text-white">Status Semester</h4>
                                    <p className="text-xs text-slate-500 dark:text-white/50">
                                        Semester saat ini: <strong className="text-indigo-600 dark:text-indigo-400">{semesterName || 'Aktif'}</strong>
                                    </p>
                                </div>
                                <span
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                {semesterStatus === 'active' ? (
                                    <button
                                        ...
                                        disabled={loading}
                                        className="flex-1 py-2.5 px-4 rounded-xl bg-amber-500/15 hover:bg-amber-500/25 border border-amber-500/30 text-amber-700 dark:text-amber-300 text-xs font-semibold flex items-center justify-center gap-2 transition cursor-pointer"
                                    >
                                    ...
                                    <button
                                        ...
                                        disabled={loading}
                                        className="flex-1 py-2.5 px-4 rounded-xl bg-emerald-500/15 hover:bg-emerald-500/25 border border-emerald-500/30 text-emerald-700 dark:text-emerald-300 text-xs font-semibold flex items-center justify-center gap-2 transition cursor-pointer"
                                    >
                ...
                {activeSubTab === 'payment' && (
                    <div className="space-y-4 animate-fade-in">
                        ...
                        <button
                            ...
                            className="px-3 py-1.5 rounded-xl bg-indigo-50 dark:bg-indigo-600/20 hover:bg-indigo-100 dark:hover:bg-indigo-600/30 border border-indigo-200 dark:border-indigo-500/30 text-indigo-700 dark:text-indigo-300 text-xs font-semibold flex items-center gap-1.5 transition cursor-pointer"
                        >
                    ...
                    {paymentAccounts.length === 0 ? (
                        <div className="p-8 text-center border border-dashed border-slate-300 dark:border-white/10 rounded-2xl bg-slate-50/50 dark:bg-white/[0.02]">
                            <CreditCard className="w-8 h-8 text-slate-400 dark:text-white/20 mx-auto mb-2" />
                            <p className="text-xs text-slate-500 dark:text-white/50">Belum ada rekening pembayaran yang ditambahkan.</p>
                            <button
                                type="button"
                                onClick={handleAddAccount}
                                className="mt-3 text-xs text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 underline font-medium cursor-pointer"
                            >
                        ...
                        <div className="space-y-3">
                            {paymentAccounts.map((acc, index) => (
                                <div
                                    key={index}
                                    className="p-3.5 rounded-2xl bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 flex flex-col md:flex-row items-center gap-3"
                                >
                                    <div className="w-full md:w-1/3">
                                        <label className="block text-[10px] text-slate-600 dark:text-white/50 mb-1">
                                            Bank / E-Wallet
                                        </label>
                                        <input
                                            type="text"
                                            ...
                                            className="w-full px-3 py-1.5 rounded-xl bg-white dark:bg-black/40 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white text-xs outline-none focus:border-indigo-500"
                                        />
                                    </div>
                                    ...
                                    <div className="w-full md:w-1/3">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-1.5 rounded-xl bg-white dark:bg-black/40 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white text-xs font-mono outline-none focus:border-indigo-500"
                                        />
                                    </div>
                                    ...
                                    <div className="self-end md:self-center pt-2 md:pt-4">
                                        <button
                                            ...
                                            className="p-2 rounded-lg bg-rose-500/10 dark:bg-rose-500/15 text-rose-600 dark:text-rose-400 hover:bg-rose-500/20 dark:hover:bg-rose-500/25 transition cursor-pointer"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-white/[0.04] border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/30 text-xs sm:text-sm focus:border-indigo-500 outline-none transition"
                        />
                    </div>
                </div>
            )}
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-white/[0.04] border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/30 text-xs sm:text-sm font-mono focus:border-emerald-500 outline-none transition"
                            />
                            <p className="text-[11px] text-slate-500 dark:text-white/40 mt-1">
                                Dapatkan gratis dari dashboard <a href="https://fonnte.com" target="_blank" rel="noreferrer" className="text-emerald-600 dark:text-emerald-400 underline font-medium">fonnte.com</a>
                            </p>
                        </div>
