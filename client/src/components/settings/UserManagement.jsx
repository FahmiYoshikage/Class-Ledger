...
const UserManagement = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-3 sm:p-6">
            {/* Header */}
            <div className="rounded-xl bg-white/[0.035] border border-white/[0.1]-apple p-4 sm:p-6 mb-4 sm:mb-6">
            ...
            {/* Users Table */}
            <div className="rounded-xl bg-white/[0.035] border border-white/[0.1]-apple overflow-hidden">
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-white/[0.04]">
                        <thead className="bg-gradient-to-r from-indigo-50 to-purple-50">
                            <tr>
                                <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/60 uppercase whitespace-nowrap">
                                    User
                                </th>
                                <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/60 uppercase whitespace-nowrap">
                                    Role
                                </th>
                                <th className="hidden md:table-cell px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/60 uppercase whitespace-nowrap">
                                    Linked Student
                                </th>
                                <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/60 uppercase whitespace-nowrap">
                                    Status
                                </th>
                                <th className="hidden lg:table-cell px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/60 uppercase whitespace-nowrap">
                                    Last Login
                                </th>
                                <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/60 uppercase whitespace-nowrap">
                                    Actions
                        ...
                        <tbody className="divide-y divide-white/[0.04]">
                            {users.map((user) => (
                                <tr key={user._id} className="hover:bg-white/[0.04]">
                                    ...
                                    <td className="hidden md:table-cell px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-white/60">
                                        {user.studentId
                                    ...
                                    <td className="hidden lg:table-cell px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-white/60 whitespace-nowrap">
                                        {user.lastLogin
                                            ? new Date(
                                                  user.lastLogin
            ...
            {showPasswordModal && resetPasswordData && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 z-50 backdrop-animate">
                    <div className="bg-[#1e1e22]/98 backdrop-blur-xl border border-white/[0.1]  rounded-xl max-w-md w-full p-6">
                        ...
                        <div className="space-y-4 bg-white/[0.04] rounded-lg p-4 mb-6">
                            <div>
                                <label className="text-xs font-semibold text-white/60 uppercase block mb-2">
                                    Username
                                </label>
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        readOnly
                                        className="flex-1 px-3 py-2 rounded-xl bg-white/[0.035] border border-white/[0.1] font-mono text-sm"
                                    />
                                    <button
                                        onClick={() =>
                                            copyToClipboard(
                                        ...
                                        className="p-2 text-white/60 hover:text-white hover:bg-white/[0.07] rounded-lg transition"
                                        title="Copy username"
                                    >
