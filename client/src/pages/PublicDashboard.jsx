                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-white text-indigo-600 px-3 sm:px-4 py-2 rounded-lg hover:bg-white/90 transition-all shadow-lg text-sm sm:text-base"
                        >
