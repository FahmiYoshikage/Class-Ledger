...
const PublicDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
            ...
            <div className="bg-slate-700/50 backdrop-blur-md border-b border-white/20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
                    <div>
                        <h1 className="text-xl sm:text-2xl font-bold text-slate-50">
                            💰 Kas Kelas
                        </h1>
                        <p className="text-sm text-slate-50/80 hidden sm:block">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        <button
                            ...
                            className="flex items-center gap-2 bg-yellow-400 text-slate-50 px-3 sm:px-4 py-2 rounded-lg hover:bg-yellow-300 transition-all shadow-lg text-sm sm:text-base font-medium"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-white text-cyan-400 px-3 sm:px-4 py-2 rounded-lg hover:bg-white/90 transition-all shadow-lg text-sm sm:text-base"
                        >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
                ...
                <div className="text-center mb-8 sm:mb-12">
                    <h2 className="text-3xl sm:text-5xl font-bold text-slate-50 mb-3 sm:mb-4">
                        {formatCurrency(stats.balance)}
                    </h2>
                    <p className="text-base sm:text-xl text-slate-50/90">
                        Total Saldo Kas Kelas
                    </p>
                    <div className="flex items-center justify-center gap-4 sm:gap-6 mt-4 sm:mt-6 text-slate-50/80 text-sm sm:text-base">
                    ...
                    <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl p-6 sm:p-8">
                        <div className="flex items-center gap-4 mb-4">
                            <div className="bg-red-100 p-3 sm:p-4 rounded-xl">
                                <TrendingDown className="w-6 h-6 sm:w-8 sm:h-8 text-rose-300" />
                            </div>
                            <div>
                                <p className="text-sm sm:text-base text-slate-300 font-medium">
                                    Total Pengeluaran
                    ...
                    <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl p-6 sm:p-8 mb-6 sm:mb-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {events.map((event, idx) => (
                                ...
                                >
                                    <h4 className="font-bold text-base sm:text-lg text-slate-50 mb-2">
                                        {event.name || 'Event'}
                                    </h4>
                                    ...
                                    <div className="mt-3 bg-slate-800/90 border border-slate-700/50 rounded-lg overflow-hidden">
                                        <div
                            ...
                            {leaderboard.map((member, index) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className="flex items-center justify-between p-3 sm:p-4 rounded-xl bg-gradient-to-r from-gray-50 to-white border border-slate-700/50 bg-slate-800/60 text-slate-50 hover:shadow-md transition-shadow"
                                    >
                                        <div className="flex items-center gap-3 flex-1 min-w-0">
                                            ...
                                            <div
                                                className={`flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center ${
                                                    index < 3
                                                        ? `bg-gradient-to-br ${rankColor} text-slate-50 shadow-md`
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <h4 className="font-bold text-sm sm:text-base text-slate-50 truncate">
                                                    {member.studentName}
                                                </h4>
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl p-6 sm:p-8 text-center">
                    <Wallet className="w-12 h-12 sm:w-16 sm:h-16 text-cyan-400 mx-auto mb-4" />
                    <h3 className="text-xl sm:text-2xl font-bold text-slate-50 mb-2 sm:mb-3">
                    ...
                    <button
                        onClick={() => navigate('/login')}
                        className="bg-gradient-to-r from-indigo-600 to-purple-600 text-slate-50 px-6 sm:px-8 py-3 sm:py-4 rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg text-sm sm:text-base font-semibold"
                    >
                        Login Sekarang
                    </button>
                </div>
            ...
            {/* Footer */}
            <div className="bg-slate-700/50 backdrop-blur-md border-t border-white/20 mt-8 sm:mt-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 text-center text-slate-50/80 text-xs sm:text-sm">
