        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-amber-50 border border-yellow-200 rounded-lg p-6">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-3 sm:p-6">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Student Info Card */}
                <div className="bg-[#0071e3] rounded-xl shadow-apple p-4 sm:p-6 mb-4 sm:mb-6 text-white">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-4 sm:mb-6">
                    {/* Personal Payment */}
                    <div className="bg-white backdrop-blur-xl border border-gray-200 shadow-apple-sm rounded-xl p-4 sm:p-6">
                        <div className="flex items-center justify-between mb-3 sm:mb-4">
                            <div className="bg-green-100 p-2 sm:p-3 rounded-lg">
                                <DollarSign className="w-5 h-5 sm:w-6 sm:h-6 text-[#0071e3]" />
                            </div>
                        </div>
                ...
                {/* Payment History */}
                <div className="bg-white backdrop-blur-xl border border-gray-200 shadow-apple-sm rounded-xl mb-4 sm:mb-6">
                    <div className="p-4 sm:p-6 border-b border-gray-200">
                        <h2 className="text-lg sm:text-xl font-bold text-gray-900 flex items-center gap-2">
                            <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-[#0071e3]" />
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-100">
                                        {payments.map((payment) => (
                                            <tr key={payment._id}>
                                                ...
                                                <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-xs sm:text-sm font-semibold text-[#0071e3]">
                                                    {formatCurrency(
                                                        payment.amount
                                                    )}
                                                </td>
                                            ...
                                            <div className="flex items-center gap-3 flex-1 min-w-0">
                                                ...
                                                <div
                                                    className={`flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center ${
                                                        index < 3
                                                            ? `bg-gradient-to-br ${rankColor} text-gray-900`
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {isCurrentUser && (
                                                            <span className="text-xs bg-[#0071e3] text-white px-2 py-0.5 rounded-full">
                                                                Anda
                                                            </span>
                                                        )}
                                                    </div>
